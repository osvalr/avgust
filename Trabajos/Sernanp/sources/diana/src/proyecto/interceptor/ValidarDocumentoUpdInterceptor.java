...
public class ValidarDocumentoUpdInterceptor implements Interceptor {
	...
	public String intercept(ActionInvocation arg0) throws Exception{
		...
		int idtipo = Integer.valueOf(request.getParameter("tipodocumento[0].idtipo"));
		String numdoc = request.getParameter("personalregistro[0].numerodocumento");
		int idpr = Integer.valueOf(request.getParameter("idpersonalregistro"));
				
		
		int cont = 0;
		
		cont = personalregistroService.listarPersonalxTipoNumdoc(idtipo, numdoc, operadorturismo.getIdpersonajuridica(),  idpr);
