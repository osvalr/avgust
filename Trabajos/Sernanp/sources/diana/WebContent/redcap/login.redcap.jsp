...
<!-- Content -->
		...
		<div id="loginPanel" class="r l" style="margin: 0 auto;">
			<h1>Ingresar al sistema</h1> 
			<form action="<%=request.getContextPath() %>/Login.action" method="post">
			<input type="hidden"  name="paginalogin"  value="4" />
			<table>
			<tr>
				<td>
				<label >Usuario:</label>
...
<!-- 			<div class="titleModulo">PLATAFORMA DIGITAL DE CAPACITACI&Oacute;N</div> -->
...
<!-- 			</div> -->
		...
		<div>
		  <img src="<%=request.getContextPath() %>/img/portadacapacitacion.png" />
		</div>
