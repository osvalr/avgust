...
@Service
public class ReporteBancoServiceImpl extends HelperServiceMybatisImpl implements ReporteBancoService {
	...
	@Transactional
	@Override
	public Integer create(ReporteBancoQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(ReporteBancoQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(ReporteBancoQuery model) throws BusinessException {
