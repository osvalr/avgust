...
@Service
public class ReporteResumenPlanillaPagoServiceImpl extends HelperServiceMybatisImpl implements ReporteResumenPlanillaPagoService {
	...
	@Transactional
	@Override
	public Integer create(RpResumenPlanillaPagosQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpResumenPlanillaPagosQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpResumenPlanillaPagosQuery model) throws BusinessException {
