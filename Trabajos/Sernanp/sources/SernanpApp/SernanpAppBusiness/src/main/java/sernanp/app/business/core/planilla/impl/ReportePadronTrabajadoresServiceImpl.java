...
@Service
public class ReportePadronTrabajadoresServiceImpl extends HelperServiceMybatisImpl implements ReportePadronTrabajadoresService {
	...
	@Transactional
	@Override
	public Integer create(RpPadronTrabajadoresQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpPadronTrabajadoresQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpPadronTrabajadoresQuery model) throws BusinessException {
