...
@Service
public class ReporteSeleccionPostulantesEntrevistaPersonalServiceImpl extends HelperServiceMybatisImpl implements ReporteSeleccionPostulantesEntrevistaPersonalService {
	...
	@Transactional
	@Override
	public Integer create(RpSeleccionPostulantesEntrevistaPersonalQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpSeleccionPostulantesEntrevistaPersonalQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpSeleccionPostulantesEntrevistaPersonalQuery model) throws BusinessException {
