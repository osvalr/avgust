...
public class DiasNoLaborablesDTO {
	
	  private Integer srl_id_no_laborable;
	  
	  private String dte_fec_no_laborable;
	...
	public String getDte_fec_no_laborable() {
		return dte_fec_no_laborable;
	}

	public void setDte_fec_no_laborable(String dte_fec_no_laborable) {
