...
@Service
public class RpPlanillaCasMesAnioServiceImpl extends HelperServiceMybatisImpl implements RpPlanillaCasMesAnioService {
	...
	@Transactional
	@Override
	public Integer create(RpPlanillaCasMesAnioQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpPlanillaCasMesAnioQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpPlanillaCasMesAnioQuery model) throws BusinessException {
