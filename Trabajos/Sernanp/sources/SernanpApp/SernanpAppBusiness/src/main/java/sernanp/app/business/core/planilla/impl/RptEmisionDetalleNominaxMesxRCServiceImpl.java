...
@Service
public class RptEmisionDetalleNominaxMesxRCServiceImpl extends HelperServiceMybatisImpl implements RptEmisionDetalleNominaxMesxRCService {
	...
	@Transactional
	@Override
	public Integer create(RptEmitirDetalleNominaxMesxRCQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RptEmitirDetalleNominaxMesxRCQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RptEmitirDetalleNominaxMesxRCQuery model) throws BusinessException {
