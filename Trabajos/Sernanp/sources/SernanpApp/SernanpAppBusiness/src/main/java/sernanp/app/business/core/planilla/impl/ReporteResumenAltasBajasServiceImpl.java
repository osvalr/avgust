...
@Service
public class ReporteResumenAltasBajasServiceImpl extends HelperServiceMybatisImpl implements ReporteResumenAltasBajasService {
	...
	@Transactional
	@Override
	public Integer create(ReporteResumenAltasBajasQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(ReporteResumenAltasBajasQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(ReporteResumenAltasBajasQuery model) throws BusinessException {
