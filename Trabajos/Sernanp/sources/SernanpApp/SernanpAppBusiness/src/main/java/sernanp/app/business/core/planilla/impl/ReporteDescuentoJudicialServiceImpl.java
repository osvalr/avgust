...
@Service
public class ReporteDescuentoJudicialServiceImpl extends HelperServiceMybatisImpl implements ReporteDescuentoJudicialService {
	...
	@Transactional
	@Override
	public Integer create(RpDescuentoJudicialQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpDescuentoJudicialQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpDescuentoJudicialQuery model) throws BusinessException {
