...
@Service
public class ReporteCertificadoCuartaCategoriaServiceImpl extends HelperServiceMybatisImpl implements ReporteCertificadoCuartaCategoriaService {
	...
	@Transactional
	@Override
	public Integer create(RpCertificadoCuartaCategoriaQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpCertificadoCuartaCategoriaQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpCertificadoCuartaCategoriaQuery model) throws BusinessException {
