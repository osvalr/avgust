...
@Service
public class RptResumenPadronTrabajadoresServiceImpl extends HelperServiceMybatisImpl implements RptResumenPadronTrabajadoresService {
	...
	@Transactional
	@Override
	public Integer create(RptResumenPadronTrabajadoresQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RptResumenPadronTrabajadoresQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RptResumenPadronTrabajadoresQuery model) throws BusinessException {
