...
@Service
public class ReporteSeleccionPostulantesFichaPostulacionServiceImpl extends HelperServiceMybatisImpl implements ReporteSeleccionPostulantesFichaPostulacionService {
	...
	@Transactional
	@Override
	public Integer create(RpSeleccionPostulantesFichaPostulacionQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(RpSeleccionPostulantesFichaPostulacionQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(RpSeleccionPostulantesFichaPostulacionQuery model) throws BusinessException {
