...
@Service
public class ResumenPlanillaPagosAfpServiceImpl extends HelperServiceMybatisImpl implements ResumenPlanillaPagosAfpService {
	...
	@Transactional
	@Override
	public Integer create(ResumenPlanillaPagosAfpQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void save(ResumenPlanillaPagosAfpQuery model) throws BusinessException {
	...
	@Transactional
	@Override
	public void remove(ResumenPlanillaPagosAfpQuery model) throws BusinessException {
