...
public class UltimaFotoPersonalQuery {
	...
	private String num_size_archivo;
	...
	public String getNum_size_archivo() {
		return num_size_archivo;
	}

	public void setNum_size_archivo(String num_size_archivo) {
