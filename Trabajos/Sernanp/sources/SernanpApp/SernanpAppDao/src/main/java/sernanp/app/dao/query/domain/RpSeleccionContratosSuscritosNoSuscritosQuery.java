...
public class RpSeleccionContratosSuscritosNoSuscritosQuery implements java.io.Serializable { 
...
private String des_estado_convocatoria; 
private Integer estado_postulante_cnv_area_org; 
...
public String getDes_estado_convocatoria() { 
  return des_estado_convocatoria; 
} 
public void setDes_estado_convocatoria(String des_estado_convocatoria) { 
  this.des_estado_convocatoria = des_estado_convocatoria; 
} 
public Integer getEstado_postulante_cnv_area_org() { 
  return estado_postulante_cnv_area_org; 
} 
public void setEstado_postulante_cnv_area_org(Integer estado_postulante_cnv_area_org) { 
  this.estado_postulante_cnv_area_org = estado_postulante_cnv_area_org; 
} 
public String getDes_estado_postulante_cnv_area_org() { 
  return des_estado_postulante_cnv_area_org; 
} 
public void setDes_estado_postulante_cnv_area_org(String des_estado_postulante_cnv_area_org) { 
