...
public class ResumenNominaPagosQuery implements java.io.Serializable {
	...
	private Double dec_monto_calculado_tot;
	...
	public Double getDec_monto_calculado_tot() {
		return dec_monto_calculado_tot;
	}
	public void setDec_monto_calculado_tot(Double dec_monto_calculado_tot) {
		this.dec_monto_calculado_tot = dec_monto_calculado_tot;
	}
