...
public class RpPadronTrabajadoresQuery implements java.io.Serializable { 
...
private String termino_contrato; 
...
private String var_cod_nivel_estudio; 
private String var_descripcion_nivel_estudio; 
...
private Double quinta_categoria; 
private Double cuarta_categoria; 
...
public String getTermino_contrato() { 
  return termino_contrato; 
} 
public void setTermino_contrato(String termino_contrato) { 
...
public String getVar_cod_nivel_estudio() { 
  return var_cod_nivel_estudio; 
} 
public void setVar_cod_nivel_estudio(String var_cod_nivel_estudio) { 
  this.var_cod_nivel_estudio = var_cod_nivel_estudio; 
} 
public String getVar_descripcion_nivel_estudio() { 
  return var_descripcion_nivel_estudio; 
} 
public void setVar_descripcion_nivel_estudio(String var_descripcion_nivel_estudio) { 
  this.var_descripcion_nivel_estudio = var_descripcion_nivel_estudio; 
} 
...
public Double getQuinta_categoria() { 
  return quinta_categoria; 
} 
public void setQuinta_categoria(Double quinta_categoria) { 
  this.quinta_categoria = quinta_categoria; 
} 
public Double getCuarta_categoria() { 
  return cuarta_categoria; 
} 
public void setCuarta_categoria(Double cuarta_categoria) { 
  this.cuarta_categoria = cuarta_categoria; 
} 
