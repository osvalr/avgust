...
public class PersonalAsistenciaRecordVO {
	private PersonalVO personal;
	private PersonalAsistenciaResumenVO asistenciaResumen;
	...
	public PersonalAsistenciaResumenVO getAsistenciaResumen() {
		return asistenciaResumen;
	}
	public void setAsistenciaResumen(PersonalAsistenciaResumenVO asistenciaResumen) {
		this.asistenciaResumen = asistenciaResumen;
	}
