...
Ext.define('MyApp.view.GestionarAsignarConcepto.PersonalConceptoFrecuenciaQueryEdit', {
    extend: 'Ext.window.Window',
    alias : 'widget.PersonalConceptoFrecuenciaQueryEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                xtype: 'form',
                id: 'form_submodel_PersonalConceptoFrecuenciaQuery',
                padding: '5 5 0 5',
                border: false,
