...
Ext.define('MyApp.view.ReporteResumenGeneralPlanilla.EditGenerarJOR', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteResumenGeneralPlanillaEditGenerarJOR',
		                		...
		                		items: [
											{
											    ...
											    listeners : {
											    	change: function(field, newValue, oldValue) {
											    		...
											    		var form = Ext.getCmp('form_generar_jor');
