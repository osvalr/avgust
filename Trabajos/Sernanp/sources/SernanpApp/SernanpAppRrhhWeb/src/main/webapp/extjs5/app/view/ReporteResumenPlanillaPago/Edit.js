...
Ext.define('MyApp.view.ReporteResumenPlanillaPago.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteResumenPlanillaPagoEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReporteResumenPlanillaPago',
				                padding: '5 5 0 5',
				                border: false,
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReporteResumenPlanillaPago_statusbar'
        })];
