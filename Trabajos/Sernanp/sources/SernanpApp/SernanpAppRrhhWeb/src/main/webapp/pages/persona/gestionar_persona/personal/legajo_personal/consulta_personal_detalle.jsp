   ...
   <div class="page-content">
      <div class="row">
		<div class="page-title">
				<h3>
					Gestionar <span class="semi-bold">Consulta del Personal</span>
				</h3>
		</div>
	    <ol class="breadcrumb">
...
<!-- 								</button> -->
								<a class="btn btn-default fa fa-reply" href="<%=request.getContextPath()%>/consulta-personal.action" >
									ir al Inicio
								</a>
