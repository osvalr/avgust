...
var component = 'GestionarConfiguracionEtapaList';
var controllerNames = [                
						'MyApp.controller.GestionarConfiguracionEtapa.MainController',
						'MyApp.controller.GestionarConfiguracionEtapa.ConfiguracionEtapaQueryController'
                     ];
</script>
