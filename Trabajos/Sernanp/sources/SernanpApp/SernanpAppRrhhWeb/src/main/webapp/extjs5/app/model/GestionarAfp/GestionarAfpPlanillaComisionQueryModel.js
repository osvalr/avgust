...
Ext.define('MyApp.model.GestionarAfp.GestionarAfpPlanillaComisionQueryModel', {
    extend: 'Ext.data.Model',
    fields: [		
    	     {name: 'srl_id_afp_comision', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ...
            ,{name: 'dec_aporte', type: 'float', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'dec_seguro', type: 'float', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'dec_comision', type: 'float', useNull: true, defaultValue:null, allowNull:true}
   ...
   idProperty:'srl_id_afp_comision'
});