...
Ext.define('MyApp.view.GestionarConfiguracionEtapa.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.GestionarConfiguracionEtapaEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_GestionarConfiguracionEtapa',
				                padding: '5 5 0 5',
				                border: false,
							...
							,{
					    		title: 'Etapa',
					    		glyph:'xf022@FontAwesome',
					    		items: [{id:'subModel_ConfiguracionEtapaQuery', xtype:'ConfiguracionEtapaQueryList'}]
							}
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_GestionarConfiguracionEtapa_statusbar'
        })];
