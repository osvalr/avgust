...
Ext.define('MyApp.view.GestionaNomina.IngresosNominaConceptoQueryEdit', {
    extend: 'Ext.window.Window',
    alias : 'widget.IngresosNominaConceptoQueryEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                xtype: 'form',
                id: 'form_submodel_IngresosNominaConceptoQuery',
                padding: '5 5 0 5',
                border: false,
					...
					,{
						...
						listeners : {
						     change: function(field, newValue, oldValue) {
						          ...
						          var form = Ext.getCmp('form_submodel_IngresosNominaConceptoQuery');
