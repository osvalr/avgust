...
var component = 'GestionarFactorEvaluacionList';
var controllerNames = [                
						'MyApp.controller.GestionarFactorEvaluacion.MainController',
						'MyApp.controller.GestionarFactorEvaluacion.FactorEvaluacionQueryController'
                     ];
</script>
