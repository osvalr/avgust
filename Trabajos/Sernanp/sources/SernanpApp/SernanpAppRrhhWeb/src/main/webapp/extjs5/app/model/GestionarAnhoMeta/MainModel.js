...
Ext.define('MyApp.model.GestionarAnhoMeta.MainModel', {
    extend: 'Ext.data.Model',
    fields: [
    	     {name: 'srl_id_anio_meta', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ...
            ,{name: 'cod_meta', type: 'string', useNull: true, defaultValue:null, allowNull:true}
