...
Ext.define('MyApp.view.GestionarConcepto.ConceptoFrecuenciaQueryEdit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ConceptoFrecuenciaQueryEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                xtype: 'form',
                id: 'form_submodel_ConceptoFrecuenciaQuery',
                padding: '5 5 0 5',
                border: false,
                ...
                items: [
					{
						...
						hidden : true,
						editable : true,
						fieldLabel : 'srl_id_frecuencia',
						name : 'srl_id_frecuencia',
						disabled : false,
						readOnly : false
					},
					{
