...
Ext.define('MyApp.view.GestionaNomina.DescuentosNominaConceptoQueryEdit', {
    extend: 'Ext.window.Window',
    alias : 'widget.DescuentosNominaConceptoQueryEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                xtype: 'form',
                id: 'form_submodel_DescuentosNominaConceptoQuery',
                padding: '5 5 0 5',
                border: false,
					...
					,{
						...
						listeners : {
						     change: function(field, newValue, oldValue) {
						          ...
						          var form = Ext.getCmp('form_submodel_DescuentosNominaConceptoQuery');
