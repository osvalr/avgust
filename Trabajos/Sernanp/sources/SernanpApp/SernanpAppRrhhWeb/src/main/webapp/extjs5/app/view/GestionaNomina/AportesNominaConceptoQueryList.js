...
Ext.define('MyApp.view.GestionaNomina.AportesNominaConceptoQueryList' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.AportesNominaConceptoQueryList',
    
    glyph:'xf022@FontAwesome',
	header: false,
    store: 'GestionaNomina.AportesNominaConceptoQueryStore',
