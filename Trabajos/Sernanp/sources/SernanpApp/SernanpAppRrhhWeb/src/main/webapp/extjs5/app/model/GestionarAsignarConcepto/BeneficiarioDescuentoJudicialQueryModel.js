...
Ext.define('MyApp.model.GestionarAsignarConcepto.BeneficiarioDescuentoJudicialQueryModel', {
    ...
    fields: [		
            ...
            ,{name: 'int_id_tipo_documento', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ...
            ,{name: 'var_nombres', type: 'string', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'var_ape_pater', type: 'string', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'var_ape_mater', type: 'string', useNull: true, defaultValue:null, allowNull:true}
   ...
   idProperty:'srl_id_beneficiario_descuento_judicial'
});