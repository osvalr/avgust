...
Ext.define('MyApp.view.ReporteResumenAltasBajas.Filter', {

    extend: 'Ext.form.Panel',
    alias: 'widget.ReporteResumenAltasBajasFilter',
    requires: ['Ext.form.Panel'],
    
    id:'form_filter_ReporteResumenAltasBajas',
	layout: {
        type: 'vbox'
    },
    fieldDefaults: {
    ...
    initComponent: function() {
    	...
    	var estado = Ext.create('Ext.data.Store', {
	        fields: ['int_estado', 'estado'],
	        data : [
	            {"int_estado":"", "estado":"-- Todos --"},
	            {"int_estado":"0", "estado":"ACTIVO"},
	            {"int_estado":"1", "estado":"INACTIVO"}
