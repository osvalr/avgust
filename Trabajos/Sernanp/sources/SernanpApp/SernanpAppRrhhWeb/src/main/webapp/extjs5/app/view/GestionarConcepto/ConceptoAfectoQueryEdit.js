...
Ext.define('MyApp.view.GestionarConcepto.ConceptoAfectoQueryEdit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ConceptoAfectoQueryEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                xtype: 'form',
                id: 'form_submodel_ConceptoAfectoQuery',
                padding: '5 5 0 5',
                border: false,
                ...
                items: [
					{
						...
						hidden : true,
						editable : true,
						fieldLabel : 'srl_id_afecto_concepto',
						name : 'srl_id_afecto_concepto',
						disabled : false,
						readOnly : false
					}
					,{
					...
					,{
						...
						listeners : {
						     change: function(field, newValue, oldValue) {
						          ...
						          var form = Ext.getCmp('form_submodel_ConceptoAfectoQuery');
					...
					,{
						...
						listeners : {
						     change: function(field, newValue, oldValue) {
						          ...
						          var form = Ext.getCmp('form_submodel_ConceptoAfectoQuery');
						          var on_field = form.getForm().findField('srl_id_concepto_planilla_afecto');
						          on_field.setDisabled(true);
						          on_field.store.removeAll();
					...
					,{
						...
						fieldLabel : 'Concepto',
						name : 'srl_id_concepto_planilla_afecto',
