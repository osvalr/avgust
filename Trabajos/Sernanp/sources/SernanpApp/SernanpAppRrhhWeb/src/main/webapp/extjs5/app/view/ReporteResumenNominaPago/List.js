...
Ext.define('MyApp.view.ReporteResumenNominaPago.List' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.ReporteResumenNominaPagoList',
    
    requires: ['MyApp.view.ReporteResumenNominaPago.Filter'],

    glyph:'xf022@FontAwesome',

    title : 'ReporteResumenNominaPago',
    store: 'ReporteResumenNominaPago.MainStore',
	...
	initComponent: function() {
		...
		this.dockedItems = [
		     {
		          xtype: 'ReporteResumenNominaPagoFilter'
		     },
			 {
	            xtype: 'toolbar',
	            items: [
