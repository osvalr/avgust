...
Ext.define('MyApp.view.RptEmisionDetalleNominaxMesxRC.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.RptEmisionDetalleNominaxMesxRCEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_RptEmisionDetalleNominaxMesxRC',
				                padding: '5 5 0 5',
				                border: false,
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_RptEmisionDetalleNominaxMesxRC_statusbar'
        })];
