...
var component = 'GestionarPlazaListAlterno';
var controllerNames = [                
						'MyApp.controller.GestionarPlaza.MainController',
						'MyApp.controller.GestionarPlaza.ArchivoPlazaQueryController',
						'MyApp.controller.GestionarPlaza.PostulantePlazaQueryController',
						'MyApp.controller.GestionarPlaza.SubEtapaPlazaQueryController'
                    ];
</script>
