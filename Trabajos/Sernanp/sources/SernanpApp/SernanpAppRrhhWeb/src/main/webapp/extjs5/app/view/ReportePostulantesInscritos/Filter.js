...
Ext.define('MyApp.view.ReportePostulantesInscritos.Filter', {

    extend: 'Ext.form.Panel',
    alias: 'widget.ReportePostulantesInscritosFilter',
    requires: ['Ext.form.Panel'],
    
    id:'form_filter_ReportePostulantesInscritos',
	layout: {
        type: 'vbox'
    },
    fieldDefaults: {
