...
Ext.define('MyApp.view.ReporteCertificadoCuartaCategoria.Filter', {

    extend: 'Ext.form.Panel',
    alias: 'widget.ReporteCertificadoCuartaCategoriaFilter',
    requires: ['Ext.form.Panel'],
    
    id:'form_filter_ReporteCertificadoCuartaCategoria',
	layout: {
        type: 'vbox'
    },
    fieldDefaults: {
