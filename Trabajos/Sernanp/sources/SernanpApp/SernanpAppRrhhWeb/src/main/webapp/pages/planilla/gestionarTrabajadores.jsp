...
var component = 'GestionarTrabajadoresList';
var controllerNames = [                
						'MyApp.controller.GestionarTrabajadores.MainController',
						'MyApp.controller.GestionarTrabajadores.GestionarTrabajadoresPresupuestoQueryController'
                     ];
</script>
