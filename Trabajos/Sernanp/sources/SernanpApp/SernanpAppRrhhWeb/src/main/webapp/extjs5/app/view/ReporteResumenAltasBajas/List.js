...
Ext.define('MyApp.view.ReporteResumenAltasBajas.List' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.ReporteResumenAltasBajasList',
    
    requires: ['MyApp.view.ReporteResumenAltasBajas.Filter'],

    glyph:'xf022@FontAwesome',

    title : 'ReporteResumenAltasBajas',
    store: 'ReporteResumenAltasBajas.MainStore',
/*
    columns: [
		{
	    	header: "Año",
	...
	initComponent: function() {
		...
		this.dockedItems = [
		     {
		          xtype: 'ReporteResumenAltasBajasFilter'
		     },
			 {
	            xtype: 'toolbar',
	            items: [
