...
Ext.define('MyApp.view.ReportePostulantesInscritos.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReportePostulantesInscritosEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReportePostulantesInscritos',
				                padding: '5 5 0 5',
				                border: false,
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReportePostulantesInscritos_statusbar'
        })];
