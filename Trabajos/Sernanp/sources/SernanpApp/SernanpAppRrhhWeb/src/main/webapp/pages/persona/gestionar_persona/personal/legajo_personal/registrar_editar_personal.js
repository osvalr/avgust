...
//	deshabilitarHabilitarAFP(); COMENTADO 30-04-2015 DVR
...
/* 10-07-2015 (D.V.R), SE QUITA LA EDICIÓN A ROMER, PORQUE ESTA OPCIÓN SE ENCUENTRA EN PLANILLAS, SE AGREGO EL SIGUIENTE CODIGO  */
	  $("#srl_id_regimen_pensionario").prop('disabled',true);
	  $('#var_nombre_afp').prop('disabled', true);
	  $('#var_codigo_afiliacion').prop('disabled', true);
	  $('#dte_fecha_afiliacion').prop('disabled', true);
	  
/* 10-07-2015 (D.V.R), SE QUITA LA EDICIÓN A ROMER, PORQUE ESTA OPCIÓN SE ENCUENTRA EN PLANILLAS */
/*
...
function cargarSelec(){
	...
	$('#srl_id_entidad_bancaria').prop('disabled',true);
