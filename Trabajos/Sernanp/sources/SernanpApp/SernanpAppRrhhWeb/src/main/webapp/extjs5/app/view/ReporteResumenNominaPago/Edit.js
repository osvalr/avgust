...
Ext.define('MyApp.view.ReporteResumenNominaPago.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteResumenNominaPagoEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReporteResumenNominaPago',
				                padding: '5 5 0 5',
				                border: false,
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReporteResumenNominaPago_statusbar'
        })];
