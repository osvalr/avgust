...
Ext.define('MyApp.view.ReporteContratoSuscritosYNoSuscritos.Filter', {

    extend: 'Ext.form.Panel',
    alias: 'widget.ReporteContratoSuscritosYNoSuscritosFilter',
    requires: ['Ext.form.Panel'],
    
    id:'form_filter_ReporteContratoSuscritosYNoSuscritos',
	layout: {
        type: 'vbox'
    },
    fieldDefaults: {
