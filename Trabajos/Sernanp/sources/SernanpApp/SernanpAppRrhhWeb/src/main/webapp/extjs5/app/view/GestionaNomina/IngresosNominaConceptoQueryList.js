...
Ext.define('MyApp.view.GestionaNomina.IngresosNominaConceptoQueryList' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.IngresosNominaConceptoQueryList',
    
    glyph:'xf022@FontAwesome',
	header: false,
    store: 'GestionaNomina.IngresosNominaConceptoQueryStore',
