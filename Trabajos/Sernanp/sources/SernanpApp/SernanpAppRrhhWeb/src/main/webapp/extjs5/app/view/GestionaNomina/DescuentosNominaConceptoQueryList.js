...
Ext.define('MyApp.view.GestionaNomina.DescuentosNominaConceptoQueryList' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.DescuentosNominaConceptoQueryList',
    
    glyph:'xf022@FontAwesome',
	header: false,
    store: 'GestionaNomina.DescuentosNominaConceptoQueryStore',
