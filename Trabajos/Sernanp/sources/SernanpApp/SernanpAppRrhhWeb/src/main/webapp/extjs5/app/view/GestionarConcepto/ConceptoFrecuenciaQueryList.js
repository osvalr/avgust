...
Ext.define('MyApp.view.GestionarConcepto.ConceptoFrecuenciaQueryList' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.ConceptoFrecuenciaQueryList',
    
    glyph:'xf022@FontAwesome',
	header: false,
    store: 'GestionarConcepto.ConceptoFrecuenciaQueryStore',
