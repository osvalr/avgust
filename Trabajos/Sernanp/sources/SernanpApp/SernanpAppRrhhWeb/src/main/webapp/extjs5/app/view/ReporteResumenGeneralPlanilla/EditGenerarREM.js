...
Ext.define('MyApp.view.ReporteResumenGeneralPlanilla.EditGenerarREM', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteResumenGeneralPlanillaEditGenerarREM',
		                		...
		                		items: [
											{
											    ...
											    listeners : {
											    	change: function(field, newValue, oldValue) {
											    		...
											    		var form = Ext.getCmp('form_generar_rem');
