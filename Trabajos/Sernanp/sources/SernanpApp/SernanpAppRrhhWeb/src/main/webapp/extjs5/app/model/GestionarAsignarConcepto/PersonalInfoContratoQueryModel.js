...
Ext.define('MyApp.model.GestionarAsignarConcepto.PersonalInfoContratoQueryModel', {
    ...
    fields: [		
            ...
            ,{name: 'num_sueldo', type: 'float', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'var_ubicacion_fisica', type: 'string', useNull: true, defaultValue:null, allowNull:true}
