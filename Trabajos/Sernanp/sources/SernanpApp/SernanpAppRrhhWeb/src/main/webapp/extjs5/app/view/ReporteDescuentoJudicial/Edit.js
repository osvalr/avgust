...
Ext.define('MyApp.view.ReporteDescuentoJudicial.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteDescuentoJudicialEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReporteDescuentoJudicial',
				                padding: '5 5 0 5',
				                border: false,
				                style: 'background-color: #fff;',
				                title: 'ReporteDescuentoJudicialPersonal',
		                		...
		                		items: [
											...
											,{
											    ...
											    fieldLabel : 'var_descripcion_descuento'
											}
											,{
											    xtype : 'textfield',
											    name : 'var_numero_doc',
											    fieldLabel : 'var_numero_doc'
											}
											,{
											    xtype : 'textfield',
											    name : 'nombre_beneficiario_jud',
											    fieldLabel : 'nombre_beneficiario_jud'
											}
											,{
											    xtype : 'textfield',
											    name : 'var_numero_cuenta',
											    fieldLabel : 'var_numero_cuenta'
											}
											,{
											    xtype : 'textfield',
											    name : 'monto',
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReporteDescuentoJudicial_statusbar'
        })];
