...
Ext.define('MyApp.view.ReporteSeleccionPostulantesFichaPostulacion.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteSeleccionPostulantesFichaPostulacionEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReporteSeleccionPostulantesFichaPostulacion',
				                padding: '5 5 0 5',
				                border: false,
				                style: 'background-color: #fff;',
				                title: 'RpSeleccionPostulantesFichaPostulacionQuery',
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReporteSeleccionPostulantesFichaPostulacion_statusbar'
        })];
