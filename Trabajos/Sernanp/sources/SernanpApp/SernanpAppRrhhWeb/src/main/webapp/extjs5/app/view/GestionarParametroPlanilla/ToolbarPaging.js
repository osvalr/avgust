...
Ext.define('MyApp.view.GestionarParametroPlanilla.ToolbarPaging', {
    extend: 'Ext.toolbar.Paging',
    alias: 'widget.GestionarParametroPlanillaToolbarPaging',
    alternateClassName: [
        'GestionarParametroPlanillaToolbarPaging'
    ],
    requires: [
        'Ext.toolbar.Paging'
    ],
