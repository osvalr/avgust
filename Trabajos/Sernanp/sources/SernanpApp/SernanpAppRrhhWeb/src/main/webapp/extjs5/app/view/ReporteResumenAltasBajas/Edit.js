...
Ext.define('MyApp.view.ReporteResumenAltasBajas.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteResumenAltasBajasEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReporteResumenAltasBajas',
				                padding: '5 5 0 5',
				                border: false,
				                style: 'background-color: #fff;',
				                title: 'Reporte Resumen Altas y Bajas',
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReporteResumenAltasBajas_statusbar'
        })];
