...
var component = 'GestionarResponsablePlazaList';
var controllerNames = [                
						'MyApp.controller.GestionarResponsablePlaza.MainController',
						'MyApp.controller.GestionarResponsablePlaza.ResponsablePlazaQueryController'
                     ];
</script>
