...
Ext.define('MyApp.view.ReporteDetalleBoletaPersonal.ToolbarPaging', {
    extend: 'Ext.toolbar.Paging',
    alias: 'widget.ReporteDetalleBoletaPersonalToolbarPaging',
    alternateClassName: [
        'ReporteDetalleBoletaPersonalToolbarPaging'
    ],
    requires: [
        'Ext.toolbar.Paging'
    ],
