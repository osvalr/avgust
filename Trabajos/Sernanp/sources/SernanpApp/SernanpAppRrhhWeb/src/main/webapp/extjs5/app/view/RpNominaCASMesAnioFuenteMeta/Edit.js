...
Ext.define('MyApp.view.RpNominaCASMesAnioFuenteMeta.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.RpNominaCASMesAnioFuenteMetaEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_RpNominaCASMesAnioFuenteMeta',
				                padding: '5 5 0 5',
				                border: false,
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_RpNominaCASMesAnioFuenteMeta_statusbar'
        })];
