...
var component = 'GestionarConceptoList';
var controllerNames = [                
						'MyApp.controller.GestionarConcepto.MainController',
						'MyApp.controller.GestionarConcepto.ConceptoAfectoQueryController',
						'MyApp.controller.GestionarConcepto.ConceptoFrecuenciaQueryController'
                      ];
</script>
</html>
