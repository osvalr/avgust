...
Ext.define('MyApp.model.GestionarAsignarConcepto.SuspensionCuartaCategoriaQueryModel', {
    extend: 'Ext.data.Model',
    fields: [		
    	     {name: 'srl_id_suspension_cuarta_categoria', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ...
            ,{name: 'dte_fecha_presentacion', type: 'string', useNull: true, defaultValue:null, allowNull:true}
   ...
   idProperty:'srl_id_suspension_cuarta_categoria'
});