...
Ext.define('MyApp.model.GestionarPostulante.ArchivoPostulanteQueryModel', {
    ...
    fields: [		
            ...
            ,{name:'var_descrip_tipo_documento', type: 'string', useNull: true, defaultValue:null, allowNull:true}
