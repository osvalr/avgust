...
Ext.define('MyApp.view.ReporteSeleccionPostulantesEvaluacionEscrita.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteSeleccionPostulantesEvaluacionEscritaEdit',
    ...
    initComponent: function() {
        this.items = [
            {
                ...
                items: [
							{
				                xtype: 'form',
				                id: 'form_crud_ReporteSeleccionPostulantesEvaluacionEscrita',
				                padding: '5 5 0 5',
				                border: false,
				                style: 'background-color: #fff;',
				                title: 'Selección de Postulantes - Evaluación Escrita',
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_crud_ReporteSeleccionPostulantesEvaluacionEscrita_statusbar'
        })];
