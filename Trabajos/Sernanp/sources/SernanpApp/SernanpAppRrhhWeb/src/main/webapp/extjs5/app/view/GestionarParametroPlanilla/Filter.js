...
Ext.define('MyApp.view.GestionarParametroPlanilla.Filter', {

    extend: 'Ext.form.Panel',
    alias: 'widget.GestionarParametroPlanillaFilter',
    requires: ['Ext.form.Panel'],
    
    id:'form_filter_GestionarParametroPlanilla',
	layout: {
        type: 'vbox'
    },
    fieldDefaults: {
