...
Ext.define('MyApp.view.ConvocatoriaPlaza.EditConvocatoriaReporteVacantes', {
    extend: 'Ext.window.Window',
    alias : 'widget.ConvocatoriaPlazaEditConvocatoriaReporteVacantes',
    ...
    resizable: false,
    width: 600,
    title:'Generar Reporte Vacantes',
    ...
    initComponent: function() {
        ...
        this.dockedItems = [{
            ...
            items: ['->', {
                ...
                text: 'Generar',
                action: 'generarReporteVacantesPlaza'
            },{
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_convocatoria_vacantes_statusbar'
        })];
