...
Ext.define('MyApp.view.ConvocatoriaPlaza.EditConvocatoriaOficioMintra', {
    extend: 'Ext.window.Window',
    alias : 'widget.ConvocatoriaPlazaEditConvocatoriaOficioMintra',
    ...
    initComponent: function() {
        this.items = [
							{
				                xtype: 'form',
				                id: 'form_convocatoria_oficio_mintra',
				                padding: '5 5 0 5',
				                border: false,
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_convocatoria_oficio_mintra_statusbar'
        })];
