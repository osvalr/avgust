...
Ext.define('MyApp.view.GestionarProcesoNominas.EditNominaExtraordinaria', {
    extend: 'Ext.window.Window',
    alias : 'widget.GestionarProcesoNominasEditNominaExtraordinaria',
    ...
    resizable: false,
    width: '50%',
    title:'Procesar Nomina Extraordinaria',
    ...
    initComponent: function() {
        this.items = [
							{
				                xtype: 'form',
				                id: 'form_proceso_nomina_extraordinaria',
				                padding: '5 5 0 5',
				                border: false,
		                		...
		                		items: [
											{
											    ...
											    listeners : {
											    	change: function(field, newValue, oldValue) {
											    		...
											    		var form = Ext.getCmp('form_proceso_nomina_extraordinaria');
        ...
        this.dockedItems = [{
            ...
            items: ['->', {
                ...
                itemId: 'save',
                text: 'Procesar',
                action: 'procesarNominaExtraordinaria'
            },{
        ...
        Ext.create('Ext.ux.StatusBar', {
            dock: 'bottom',
            id: 'form_proceso_nomina_extraordinaria_statusbar'
        })];
