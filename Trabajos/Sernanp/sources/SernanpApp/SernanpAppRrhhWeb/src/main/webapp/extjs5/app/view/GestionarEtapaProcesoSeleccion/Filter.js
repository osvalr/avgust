...
Ext.define('MyApp.view.GestionarEtapaProcesoSeleccion.Filter', {

    extend: 'Ext.form.Panel',
    alias: 'widget.GestionarEtapaProcesoSeleccionFilter',
    requires: ['Ext.form.Panel'],
    
    id:'form_filter_GestionarEtapaProcesoSeleccion',
	layout: {
        type: 'vbox'
    },
    fieldDefaults: {
