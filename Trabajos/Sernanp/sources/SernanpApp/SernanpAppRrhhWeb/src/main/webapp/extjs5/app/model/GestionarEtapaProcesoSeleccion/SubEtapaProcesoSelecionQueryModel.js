...
Ext.define('MyApp.model.GestionarEtapaProcesoSeleccion.SubEtapaProcesoSelecionQueryModel', {
    ...
    fields: [		
            ...
            ,{name: 'var_detalle_subetapa', type: 'string', useNull: true, defaultValue:null, allowNull:true}
   ...
   idProperty:'srl_id_subetapa_proceso_seleccion'
});