...
Ext.define('MyApp.model.GestionarConcepto.MainModel', {
    ...
    fields: [
            ...
            ,{name: 'var_cod_pdt_concepto', type: 'string', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'var_cod_mef_concepto', type: 'string', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'var_cod_siaf_concepto', type: 'string', useNull: true, defaultValue:null, allowNull:true}
   ...
   idProperty:'srl_id_concepto_planilla'
});
