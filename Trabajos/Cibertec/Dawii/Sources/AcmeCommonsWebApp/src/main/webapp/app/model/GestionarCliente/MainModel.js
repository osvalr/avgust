Ext.define('AcmeWebApp.model.GestionarCliente.MainModel', {
    ...
    fields: [
        ...
        , {name: 'id_tipo_persona', type: 'integer', useNull: true, defaultValue: null, allowNull: true}
        , {name: 'descrip_tipo_persona', type: 'string', useNull: true, defaultValue: null, allowNull: true}
        , {name: 'id_sub_tipo_persona', type: 'integer', useNull: true, defaultValue: null, allowNull: true}
        , {name: 'descrip_sub_tipo_persona', type: 'string', useNull: true, defaultValue: null, allowNull: true}

        , {name: 'razon_social', type: 'string', useNull: true, defaultValue: null, allowNull: true}
