...
@NamedQueries({
    ...
    , @NamedQuery(name = "FuncionalidadRol.findByIdFuncionalidad", query = "SELECT f FROM FuncionalidadRol f WHERE f.funcionalidadRolPK.idFuncionalidad = :idFuncionalidad")
    , @NamedQuery(name = "FuncionalidadRol.findByIdRol", query = "SELECT f FROM FuncionalidadRol f WHERE f.funcionalidadRolPK.idRol = :idRol")
    , @NamedQuery(name = "FuncionalidadRol.findByIdAplicacion", query = "SELECT f FROM FuncionalidadRol f WHERE f.funcionalidadRolPK.idAplicacion = :idAplicacion")
    , @NamedQuery(name = "FuncionalidadRol.findByIdEstado", query = "SELECT f FROM FuncionalidadRol f WHERE f.idEstado = :idEstado")
    , @NamedQuery(name = "FuncionalidadRol.findByIdUsuarioReg", query = "SELECT f FROM FuncionalidadRol f WHERE f.idUsuarioReg = :idUsuarioReg")
    , @NamedQuery(name = "FuncionalidadRol.findByFechaRegistro", query = "SELECT f FROM FuncionalidadRol f WHERE f.fechaRegistro = :fechaRegistro")
    , @NamedQuery(name = "FuncionalidadRol.findByIdUsuarioMod", query = "SELECT f FROM FuncionalidadRol f WHERE f.idUsuarioMod = :idUsuarioMod")
    , @NamedQuery(name = "FuncionalidadRol.findByFechaModificacion", query = "SELECT f FROM FuncionalidadRol f WHERE f.fechaModificacion = :fechaModificacion")})
public class FuncionalidadRol implements Serializable {
    ...
    public String toString() {
        return "pe.com.coravi.domain.hibernate.domain.FuncionalidadRol[ funcionalidadRolPK=" + funcionalidadRolPK + " ]";
    }
