...
@NamedQueries({
    ...
    , @NamedQuery(name = "UsuarioRol.findByIdAplicacion", query = "SELECT u FROM UsuarioRol u WHERE u.usuarioRolPK.idAplicacion = :idAplicacion")
    , @NamedQuery(name = "UsuarioRol.findByIdEstado", query = "SELECT u FROM UsuarioRol u WHERE u.idEstado = :idEstado")
    , @NamedQuery(name = "UsuarioRol.findByIdUsuarioReg", query = "SELECT u FROM UsuarioRol u WHERE u.idUsuarioReg = :idUsuarioReg")
    , @NamedQuery(name = "UsuarioRol.findByFechaRegistro", query = "SELECT u FROM UsuarioRol u WHERE u.fechaRegistro = :fechaRegistro")
    , @NamedQuery(name = "UsuarioRol.findByIdUsuarioMod", query = "SELECT u FROM UsuarioRol u WHERE u.idUsuarioMod = :idUsuarioMod")
...
public class UsuarioRol implements Serializable {
    ...
    public String toString() {
        return "pe.com.coravi.domain.hibernate.domain.UsuarioRol[ usuarioRolPK=" + usuarioRolPK + " ]";
    }
