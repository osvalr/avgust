...
Ext.define('MyApp.view.GestionarSaldo.ReporteSaldoWindow', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteSaldoWindow',
								...
								buttons : [
									{
										...
										handler:function () {
											...
											if (form.isValid()) {
												window.open('/InaviWSRestApp/api/report/guiasPorCobrar?'+ encodedFilename, '_blank');
											}
										}
									}
								]
