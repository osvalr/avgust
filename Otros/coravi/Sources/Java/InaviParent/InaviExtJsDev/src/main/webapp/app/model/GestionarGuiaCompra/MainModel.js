...
Ext.define('MyApp.model.GestionarGuiaCompra.MainModel', {
    ...
    fields: [
            ...
            ,{name: 'id_tipo_guia', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'descrip_tipo_guia', type: 'string', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'id_guia_referencia', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ...
            ,{name: 'id_proveedor', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
            ,{name: 'nombre_proveedor', type: 'string', useNull: true, defaultValue:null, allowNull:true}
