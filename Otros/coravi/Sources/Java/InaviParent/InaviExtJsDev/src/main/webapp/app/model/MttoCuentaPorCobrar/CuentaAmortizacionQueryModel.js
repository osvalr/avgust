...
Ext.define('MyApp.model.MttoCuentaPorCobrar.CuentaAmortizacionQueryModel', {
    extend: 'Ext.data.Model',
    fields: [		
    	     {name: 'id_cuenta_amortizacion', type: 'integer', useNull: true, defaultValue:null, allowNull:true}
   ...
   idProperty:'id_cuenta_amortizacion'
});