...
Ext.define('MyApp.view.GestionarGuia.ReporteVentaPorClienteWindow', {
    extend: 'Ext.window.Window',
    alias : 'widget.ReporteVentaPorClienteWindow',
										...
										buttons : [
											{
												...
												handler:function () {
													...
													if (form.isValid()) {
														window.open('/InaviWSRestApp/api/report/ventasPorClienteReport?'+ encodedFilename, '_blank');
													}
												}
											}
										]
