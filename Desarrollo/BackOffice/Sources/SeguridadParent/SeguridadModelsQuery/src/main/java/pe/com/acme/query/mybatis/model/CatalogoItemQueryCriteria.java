...
/**
* The CatalogoItemQueryCriteria class conten the params in shape attributes 
...
public class CatalogoItemQueryCriteria extends AbstractModelCriteria implements java.io.Serializable  { 
	...
	public CatalogoItemQueryCriteria() {
		super();
	}
