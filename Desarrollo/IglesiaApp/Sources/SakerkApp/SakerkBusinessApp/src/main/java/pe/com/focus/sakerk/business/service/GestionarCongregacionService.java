...
public interface GestionarCongregacionService extends HelperService {
	Integer create(CongregacionQuery model) throws BusinessException;
	void save(CongregacionQuery model) throws BusinessException;
	void remove(CongregacionQuery model) throws BusinessException;
}