...
Ext.define('MyApp.view.GestionarPersonaNatural.NumeroTelefonicoQueryList' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.NumeroTelefonicoQueryList',
    
    glyph:'xf022@FontAwesome',
	header: false,
    store: 'GestionarPersonaNatural.NumeroTelefonicoQueryStore',
