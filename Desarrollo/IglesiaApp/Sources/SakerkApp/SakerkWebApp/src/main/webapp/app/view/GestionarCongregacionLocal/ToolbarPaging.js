...
Ext.define('MyApp.view.GestionarCongregacionLocal.ToolbarPaging', {
    extend: 'Ext.toolbar.Paging',
    alias: 'widget.GestionarCongregacionLocalToolbarPaging',
    alternateClassName: [
        'GestionarCongregacionLocalToolbarPaging'
    ],
    requires: [
        'Ext.toolbar.Paging'
    ],
