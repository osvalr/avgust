...
Ext.define('MyApp.model.GestionarPersonaNatural.PersonaNaturalRolQueryModel', {
    extend: 'Ext.data.Model',
    fields: [		
                		{name: 'id_persona_natural_rol', type: 'integer'}
               		   ,{name: 'id_persona_natural', type: 'integer'}
               		   ,{name: 'id_rol', type: 'integer'}
   ...
   idProperty:'id_persona_natural_rol'
});