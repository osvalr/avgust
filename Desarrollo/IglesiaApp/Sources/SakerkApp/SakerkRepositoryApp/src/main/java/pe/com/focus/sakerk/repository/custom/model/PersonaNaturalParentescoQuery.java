...
public class PersonaNaturalParentescoQuery implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	private Integer id_persona_parentesco;
	private Integer id_persona_natural;
	private Integer id_persona_natural_parentesco;
	private String nombres_completos;
	private String fecha_nacimiento;
	private Integer id_tipo_documento;
	private String descrip_tipo_documento;
	private String numero_documento;
	private Integer id_tipo_parentesco;
	private String descrip_tipo_parentesco;
	...
	public Integer getId_persona_natural_parentesco() {
		return id_persona_natural_parentesco;
	}

	public void setId_persona_natural_parentesco(
			Integer id_persona_natural_parentesco) {
		this.id_persona_natural_parentesco = id_persona_natural_parentesco;
	}

	public Integer getId_tipo_parentesco() {
		return id_tipo_parentesco;
	}

	public void setId_tipo_parentesco(Integer id_tipo_parentesco) {
		this.id_tipo_parentesco = id_tipo_parentesco;
	}

	public String getDescrip_tipo_parentesco() {
		return descrip_tipo_parentesco;
	}

	public void setDescrip_tipo_parentesco(String descrip_tipo_parentesco) {
		this.descrip_tipo_parentesco = descrip_tipo_parentesco;
	}
