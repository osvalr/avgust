...
import pe.kapcom.iemail.service.CustomerServiceImpl;
...
public class App {
	...
	public static void main(String[] args) {
		...
		log.info("============ OBTENIENDO INSTANCIA DE CUSTOMER SERVICE IMPL ============");
		log.info("============ OBTENIENDO REGISTROS PENDIENTES PARA EL ENVIO DE DOCUMENTOS ELECTRONICOS ============");
		CustomerServiceImpl service = (CustomerServiceImpl) context.getBean("customerServiceImpl");
		List<CustomerMailQuery> list = service.get();
