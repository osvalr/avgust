...
Ext.define('MyApp.view.GestionarSaldo.Edit', {
    extend: 'Ext.window.Window',
    alias : 'widget.GestionarSaldoEdit',

    requires: ['Ext.form.Panel','MyApp.view.GestionarSaldo.SaldoGuiaPesoQueryList','MyApp.util.GuiaUtil'],
...
//				                glyph:'xf022@FontAwesome',
							...
							,{
					    		title: 'Saldo',
//					    		glyph:'xf022@FontAwesome',
					    		items: [{id:'subModel_GuiaSaldoQuery', xtype:'GuiaSaldoQueryList'}]
							}
							,{
					    		title: 'Pesos',
//					    		iconCls:'fa fa-list-alt',
					    		...
					    		listeners: {
					                activate: function(tab, eOpts) {
					                	var form = Ext.getCmp('form_crud_GestionarSaldo');
