...
Ext.define('MyApp.view.GestionarGuiaCompra.GuiaPesoCompraQueryList' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.GuiaPesoCompraQueryList',
	...
	header: false,
    store: 'GestionarGuiaCompra.GuiaPesoCompraQueryStore',
    features: [{
                		...
                		items: [
                                {
                                	...
                                	items: [
	        									...
	        									},
	        									{
	        										...
	        										hidden : false,
	        										editable : false,
	        										fieldLabel : 'Total Tara',
	        										name : 'total_peso_tara_devo',
	        										disabled : false,
	        										fieldStyle : 'text-align:right;font-weight: bold;color:red;',
	        										flex:1,
	        										value:0
