...
/**
* The CobrosPendientesReportQuery class is the resultset equivalent of an SQL query
...
public class CobrosPendientesReportQuery extends AbstractModel implements java.io.Serializable { 

	private static final long serialVersionUID = 1L;
	
	private Integer id_guia; 
	private String fecha_jornada; 
	private java.util.Date d_fecha_jornada; 
	...
	public java.util.Date getD_fecha_jornada() { 
	  return d_fecha_jornada; 
	} 
	public void setD_fecha_jornada(java.util.Date d_fecha_jornada) { 
	  this.d_fecha_jornada = d_fecha_jornada; 
	} 
