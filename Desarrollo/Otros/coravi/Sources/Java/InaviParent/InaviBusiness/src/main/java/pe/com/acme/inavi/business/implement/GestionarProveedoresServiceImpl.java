...
import pe.com.acme.query.mybatis.mapper.ProveedorQueryMapper;
...
@Service
public class GestionarProveedoresServiceImpl extends MybatisRepositoryHelper implements GestionarProveedoresService {
	...
	@Override
	public Integer create(ProveedorQuery model) throws Exception {
		...
		personaTipo.setId_sub_tipo_persona(InaviConstantes.SUB_TIPO_PERSONA_PROVEEDOR);
	...
	@Transactional(rollbackForClassName = {"Exception"})
	@Override
	public void update(ProveedorQuery model) throws Exception {
		...
		personaTipoKey.setId_sub_tipo_persona(InaviConstantes.SUB_TIPO_PERSONA_PROVEEDOR);
		...
		if(persona.getId_estado().intValue() != personaTipo.getId_estado().intValue()){
			...
			.andId_sub_tipo_personaEqualTo(InaviConstantes.SUB_TIPO_PERSONA_PROVEEDOR);
	...
	@Transactional(rollbackForClassName = {"Exception"})
	@Override
	public void destroy(ProveedorQuery model) throws Exception {
	...
	@Transactional(rollbackForClassName = {"Exception"})
	@Override
	public List<ProveedorQuery> list(ProveedorQueryCriteria criteria) throws Exception {
		List<ProveedorQuery> list = this.selectByQuery(ProveedorQueryMapper.class, criteria, criteria.getStart(), criteria.getLimit());
		return list;
	}

	@Transactional(rollbackForClassName = {"Exception"})
	@Override
	public int countRecords(ProveedorQueryCriteria criteria) throws Exception {
		int count = this.selectCountByQuery(ProveedorQueryMapper.class, criteria);
		return count;
	}
