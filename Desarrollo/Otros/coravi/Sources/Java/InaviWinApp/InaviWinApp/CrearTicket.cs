...
namespace CrearTicketVenta
{
    ...
    public class CrearTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            linea.AppendLine("TIPO PESO            |JABAS|AVES|PESO");
        }
        ...
        public void AgregaArticulo(string articulo, int cant, int precio, decimal importe)
        {
            //Valida que cant precio e importe esten dentro del rango.
            if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString("#,#.00").Length <= 8)
            {
                ...
                if (articulo.Length > 20)
                {
                    ...
                    nroEspacios = (8 - importe.ToString("#,#.00").Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    }
                    elemento += espacios + importe.ToString("#,#.00");//Agregamos el importe alineado a la derecha
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    elemento += espacios + importe.ToString("#,#.00");
