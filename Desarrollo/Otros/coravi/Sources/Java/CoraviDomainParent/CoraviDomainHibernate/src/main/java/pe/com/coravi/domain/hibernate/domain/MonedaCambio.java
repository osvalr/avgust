...
@NamedQueries({
    ...
    , @NamedQuery(name = "MonedaCambio.findByIdMonedaLocal", query = "SELECT m FROM MonedaCambio m WHERE m.monedaCambioPK.idMonedaLocal = :idMonedaLocal")
    , @NamedQuery(name = "MonedaCambio.findByIdMonedaForanea", query = "SELECT m FROM MonedaCambio m WHERE m.monedaCambioPK.idMonedaForanea = :idMonedaForanea")
    , @NamedQuery(name = "MonedaCambio.findByIdTipoOperador", query = "SELECT m FROM MonedaCambio m WHERE m.idTipoOperador = :idTipoOperador")
    , @NamedQuery(name = "MonedaCambio.findByPrecioCambioMoneda", query = "SELECT m FROM MonedaCambio m WHERE m.precioCambioMoneda = :precioCambioMoneda")
    , @NamedQuery(name = "MonedaCambio.findByIdEstado", query = "SELECT m FROM MonedaCambio m WHERE m.idEstado = :idEstado")
    , @NamedQuery(name = "MonedaCambio.findByIdUsuarioReg", query = "SELECT m FROM MonedaCambio m WHERE m.idUsuarioReg = :idUsuarioReg")
    , @NamedQuery(name = "MonedaCambio.findByFechaRegistro", query = "SELECT m FROM MonedaCambio m WHERE m.fechaRegistro = :fechaRegistro")
    , @NamedQuery(name = "MonedaCambio.findByIdUsuarioMod", query = "SELECT m FROM MonedaCambio m WHERE m.idUsuarioMod = :idUsuarioMod")
    , @NamedQuery(name = "MonedaCambio.findByFechaModificacion", query = "SELECT m FROM MonedaCambio m WHERE m.fechaModificacion = :fechaModificacion")})
public class MonedaCambio implements Serializable {
    ...
    public String toString() {
        return "pe.com.coravi.domain.hibernate.domain.MonedaCambio[ monedaCambioPK=" + monedaCambioPK + " ]";
    }
