...
@NamedQueries({
    ...
    , @NamedQuery(name = "Jornada.findByNumDia", query = "SELECT j FROM Jornada j WHERE j.jornadaPK.numDia = :numDia")
    , @NamedQuery(name = "Jornada.findByNumMes", query = "SELECT j FROM Jornada j WHERE j.jornadaPK.numMes = :numMes")
    , @NamedQuery(name = "Jornada.findByNumAnio", query = "SELECT j FROM Jornada j WHERE j.jornadaPK.numAnio = :numAnio")
    , @NamedQuery(name = "Jornada.findByFechaJornada", query = "SELECT j FROM Jornada j WHERE j.fechaJornada = :fechaJornada")
    , @NamedQuery(name = "Jornada.findByIdEstado", query = "SELECT j FROM Jornada j WHERE j.idEstado = :idEstado")
    , @NamedQuery(name = "Jornada.findByIdUsuarioReg", query = "SELECT j FROM Jornada j WHERE j.idUsuarioReg = :idUsuarioReg")
    , @NamedQuery(name = "Jornada.findByFechaRegistro", query = "SELECT j FROM Jornada j WHERE j.fechaRegistro = :fechaRegistro")
    , @NamedQuery(name = "Jornada.findByIdUsuarioMod", query = "SELECT j FROM Jornada j WHERE j.idUsuarioMod = :idUsuarioMod")
    , @NamedQuery(name = "Jornada.findByFechaModificacion", query = "SELECT j FROM Jornada j WHERE j.fechaModificacion = :fechaModificacion")})
public class Jornada implements Serializable {
    ...
    public String toString() {
        return "pe.com.coravi.domain.hibernate.domain.Jornada[ jornadaPK=" + jornadaPK + " ]";
    }
