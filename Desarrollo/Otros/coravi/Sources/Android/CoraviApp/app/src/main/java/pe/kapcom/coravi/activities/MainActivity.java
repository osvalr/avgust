...
public class MainActivity extends AppCompatActivityHelper
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_registrar_cobranza) {
            fragment=BuscarClienteFragment.newInstance(Constante.Flujo.REGISTRAR_COBRANZA);
            FragmentSeleccionado=true ;
        } else if (id == R.id.nav_reporte_resumen_pagos) {
            fragment=BuscarClienteFragment.newInstance(Constante.Flujo.RESUMEN_PAGOS);
            FragmentSeleccionado=true ;
